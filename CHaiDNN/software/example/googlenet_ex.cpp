...
int main(int argc, char **arcv) {
    ...
    char *dirpath    = "/home/mpa46/CHaiDNN/software/example/GoogleNetWithoutLRN/6Bit"; /* Path to the network model directory */
    char *prototxt   = "GoogleNetNoLRN_6Bit_deploy_CHaiDNN.prototxt";       /* Prototxt file name residing in network model directory */
    char *caffemodel = "GoogleNetNoLRN_6Bit_CHaiDNN.caffemodel";  /* caffemodel file name residing in network model directory */
