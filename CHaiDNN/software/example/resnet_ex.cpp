...
int main(int argc, char **arcv) {
    ...
    char *dirpath    = "/home/mpa46/CHaiDNN/software/example/ResNet-50-Legacy_NoBN/6Bit"; /* Path to the network model directory */
    char *prototxt   = "ResNet-50_NoBN_6Bit_deploy_CHaiDNN.prototxt";       /* Prototxt file name residing in network model directory */
    char *caffemodel = "ResNet-50_NoBN_6Bit_CHaiDNN.caffemodel";  /* caffemodel file name residing in network model directory */
    
    char *img_path1  = "/home/mpa46/CHaiDNN/software/example/image_2.jpg";
    char *img_path2  = "/home/mpa46/CHaiDNN/software/example/image_2.jpg";
