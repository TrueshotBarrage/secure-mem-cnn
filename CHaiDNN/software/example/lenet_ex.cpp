...
int main(int argc, char **arcv) {
    ...
    char *dirpath    = "/home/mpa46/CHaiDNN/software/example"; /* Path to the network model directory */
    char *prototxt   = "lenet.prototxt";       /* Prototxt file name residing in network model directory */
    char *caffemodel = "lenet.caffemodel";  /* caffemodel file name residing in network model directory */
    
    char *img_path1  = "/home/mpa46/CHaiDNN/software/example/image_1.jpg";
    char *img_path2  = "/home/mpa46/CHaiDNN/software/example/image_1.jpg";
